...
// 패키지 선언은 최상단에 위치하며 패키지가 잘못 작성된 경우 오류발생

package com.kh.object;

// 다른 패키지에 있는 클래스를 사용 하려면 import문을 이용해서
// 어떤 패키지의 어떤 클래스인지 명시해야 한다
// import문은 패키지의 선언과 클래스의 선언 사이에 작성
// 자동완성시 import문이 자동으로 완성되지만 코드를 따라친 경우 안 나옴 !!
